...
public class StudyGroupController {
    ...
    public StudyGroupController(StudyGroupMapper groupMapper, GroupMemberMapper memberMapper,
    ...
    @Operation(summary = "发布小组并设置预约起始时间")
    ...
    @Operation(summary = "获取我相关的学习小组列表")
    @GetMapping
    ...
    @Operation(summary = "获取小组的加入申请列表（组长）")
    ...
    @Operation(summary = "查看我提交的加入小组申请")
     ...
     * 检查协同预约的成员预约创建情况（调试用）
     */
    @Operation(summary = "检查协同预约成员预约创建情况（调试）")
     ...
     */
    @Operation(summary = "补充创建缺失成员的个人预约（组长）")
    ...
    @Operation(summary = "获取与学习小组相关的通知列表")
    ...
    @Operation(summary = "将当前用户所有小组通知标记为已读")
